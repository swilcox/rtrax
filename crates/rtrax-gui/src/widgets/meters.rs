...
pub fn show(ui: &mut egui::Ui, meters: &ChannelMeters) {
...
/// One horizontal bar: dim track, green fill going magenta above the hot
/// threshold, cyan peak-hold tick.
pub fn bar(painter: &egui::Painter, rect: Rect, env: Envelope) {
    const HOT: f32 = 0.85;
